...
int drawGL(GLvoid) {
	...
	glTranslatef(1.5f, 0.0f, -7.0f);	// cause reset the screen, focus already moves to the center
	glRotatef(rquad, 1.0f, 1.0f, 1.0f);
	glBegin(GL_QUADS);
		// draw the square top left, top right, bottom right, bottom left(clock wise).
		// top
		glColor3f(0.0f, 1.0f, 0.0f);
		glVertex3f(1.0f, 1.0f, -1.0f);
		glVertex3f(-1.0f, 1.0f, -1.0f);
